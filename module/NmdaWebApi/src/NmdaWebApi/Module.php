	...
	public function getServiceConfig()
	{
		return array(
			'factories' => array(	
				...
				'NmdaWebApi\V1\Rest\NmdadbChannelHistogramRelative\NmdadbChannelHistogramRelativeResource' => function ($sm) {
					$db1adapter = $sm->get('db1');
					$model = $sm->get('NmdaWebApi\V1\Model\nmdadbModel');
			    		return new \NmdaWebApi\V1\Rest\NmdadbChannelHistogramRelative\NmdadbChannelHistogramRelativeResource($model);
				},
