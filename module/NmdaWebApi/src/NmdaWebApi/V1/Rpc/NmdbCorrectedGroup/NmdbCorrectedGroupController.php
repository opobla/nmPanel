<?php
namespace NmdaWebApi\V1\Rpc\NmdbCorrectedGroup;

use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\JsonModel;

class NmdbCorrectedGroupController extends AbstractActionController
{
	protected $model;
	...
	public function nmdbCorrectedGroupAction(){
